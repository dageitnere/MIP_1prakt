...
def average_runtime(algorithm, depth, numbers, trials=10):
    times = []
    for num in numbers:
...
for depth in depths:
    minmax_avg = average_runtime(minMax, depth, testNumbers, trials)
    alphabeta_avg = average_runtime(alphaBeta, depth, testNumbers, trials)
